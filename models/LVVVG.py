...
class LVVVG(nn.Module):
    ...
    def forward(self, image, image_mask, word_id, word_mask):
        ...
        # 修改outputs_coord的
        # outputs_coord = outputs_coord[:, :, 0:1, :]
...
class VGCriterion(nn.Module):
    """ This class computes the loss for LVVVG."""
...
def build_vgmodel(args):
    ...
    model = LVVVG(pretrained_weights=args.load_weights_path, args=args)
