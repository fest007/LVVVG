...
# from models import build_model, build_model_change
...
def main(args):
    ...
    # model, criterion, postprocessor = build_model_change(args)
    model.to(device)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('LVVVG training script', parents=[get_args_parser()])
